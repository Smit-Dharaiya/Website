  ...
  <!-- Brand -->
  <img class="logo" src="Tiles/Capture7.jpg">
    ...
    <ul class="navbar-nav main-ul">
     ...
     <li class="dropdown">
      ...
      <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">BY APPLICATION
          ...
          <br>
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">NEW COLLECTION
            <span class="caret"></span></a>
            <ul class="d2">
              <li><a href="TilesPage2.php ? uid=CERAMIC DIGITAL TILES" role="button">CERAMIC DIGITAL TILES</a></li>
              <li><a href="TilesPage2.php ? uid=ELEVATION WALL TILES" role="button">ELEVATION WALL TILES</a></li> 
            </ul>
          </li>
        </div>
      </ul> 
      ...
      <li class="nav-item lgin">
        ...
        <?php
          if(isset($_SESSION['UserName']))
          {
            ...
            echo '<a class="nav-link" href="view_cart.php">View <i class="fa  fa-shopping-cart"></i></a>';
            echo '</li>';
          }
        ?>
