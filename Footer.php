...
<div class="final col-md-12 wow bounceInUp" style="background-color: #202020">
  <div class="corporate col-md-3">
    ...
    <ul>
      ...
      <li style="list-style: none;"><a href="dealer.php ? u=DEALER LOCATOR" style="color: white;text-decoration: none" role="button">Dealer Connect</li></a>
      <li style="list-style: none;"><a href="dealer.php ? u=OFFICE LOCATOR" style="color: white;text-decoration: none" role="button">Office</li></a>  
    ...
    <ul>
      <?php
             include('connection.php');
              ...
              {
                  echo '<li><a href="TilesPage2.php ? uid2='.$row[0].' & uid= & uid3= " role="button" style="color: white;text-decoration: none" >'.$row[0].'</a></li>';
              }
             ?>
    </ul>
  </div>
  ...
  <div class="quick col-md-3">
    ...
    <ul>
      ...
      <li style="list-style:none;"><a href="TilesPage2.php ? uid=FLOOR TILES & uid2= & uid3= " style="color: white;text-decoration: none" role="button">Floor Tiles</li></a>
      <li style="list-style:none;"><a href="TilesPage2.php ? uid=WALL TILES & uid2= & uid3= " style="color: white;text-decoration: none" role="button">Wall Tiless</li></a>
